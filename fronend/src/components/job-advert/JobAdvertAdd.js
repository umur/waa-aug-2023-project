    ...
    return ( 
        ...
        <div id="createCourseDiv" className="container">
            ...
            <form id="createCourseForm" onSubmit={handleJobAdvertCreate}>
                ...
                <div className="mb-3">
                <label htmlFor="usernameInput" className="form-label">Job Description</label>
                <input type="text" className="form-control" id="usernameInput" value={jobDescription} onChange={e => setJobDescription(e.target.value)} required />
                </div>
